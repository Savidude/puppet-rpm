...
while connecting and managing multiple identities across different applications. It enables
enterprise architects and developers to improve customer experience through a secure single
sign-on environment.

%prep
# clear BUILD directory and copy source files to BUILD directory
echo "Preparing WSO2 Identity Server - KM installation..."
rm -rf %{_topdir}/BUILD/*
...
%pre
echo "Installing WSO2 Identity Server - KM %{version}..."
...
echo ". . ."
echo "WSO2 Identity Server - KM Installed on : \"/usr/lib64/wso2/%{name}/%{version}/\""
echo "To run WSO2 Identity Server - KM as a service, open a new terminal and run:"
