...
echo "Preparing WSO2 Stream Integrator Tooling installation..."
rm -rf %{_topdir}/BUILD/*
...
%pre
echo "Installing WSO2 Stream Integrator Tooling %{version}..."
...
ln -sf %{_libdir}/wso2/%{name}/%{version}/bin/launcher_tooling.sh /usr/bin/%{name}-%{version}
...
echo ". . ."
echo "WSO2 Stream Integrator Tooling Installed on : \"/usr/lib/wso2/%{name}/%{version}/\""
echo "To run WSO2 Stream Integrator Tooling, open a new terminal and run:"
